...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data?.success && res.data?.user?.token && res.data?.user?._id) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ minHeight: 550, gap: "2rem" }} // Increased gap between form and image for better spacing
      >
        ...
        <motion.div
          ...
          style={{
            ...
            zIndex: 10,
            padding: "1.5rem", // Added padding inside image container for nice spacing
          }}
        >
          <img
            src="/images/man.png"
        ...
        {/* Login Form Card - Opacity responsive */}
        <motion.div
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6"> {/* Increased vertical spacing between inputs */}
            <div>
              <label
                htmlFor="identifier"
              ...
              <input
                ...
                style={{
                  ...
                  fontSize: 16,
                  letterSpacing: 0.2,
                  marginBottom: errors.identifier ? 6 : 24,
                }}
              />
              {errors.identifier && (
                <div className="text-red-400 text-sm mt-1">{errors.identifier}</div>
              )}
            </div>
            <div>
              <label
            ...
            <div className="flex justify-between items-center my-3 mb-6">
              ...
              >
                {/* <input
                  type="checkbox"
                  className="mr-2"
                  style={{ accentColor: "#ae48ff" }}
                /> */}
                {/* Remember me */}
              </label>
              {/* <Link
                to="/forgot-password"
                className="text-xs text-purple-200 hover:text-purple-300 transition"
      ...
      {/* Lower form opacity on phone screens */}
      <style>
        {`
